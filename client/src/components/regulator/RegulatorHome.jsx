...
const navItems = [
  ...
  { id: "comparison", label: "Case Comparison", icon: Scale },
    ...
    <div className="flex flex-col h-full">
      <div className="px-6 py-5 border-b">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-bold leading-none">Regulator Panel</h2>
            <p className="text-xs text-muted-foreground mt-0.5">Regulatory Oversight</p>
          </div>
        </div>
      </div>
...
export default function RegulatorHome() {
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case "comparison": return <CaseComparison />
